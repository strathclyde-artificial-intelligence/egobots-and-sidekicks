...
(:init
    ...
    (= (ingoal pn111) 1)
    (at 8.005 (= (ingoal pn111) 0))
    (= (ingoal pn112) 1)
    (at 7.004 (= (ingoal pn112) 0))
    (= (ingoal pn113) 1)
    (at 4.003 (= (ingoal pn113) 0))
    (= (ingoal pn114) 1)
    (at 3.002 (= (ingoal pn114) 0))

    (= (ingoal pn142) 1)
    (at 12.007 (= (ingoal pn114) 0))

    (= (ingoal pn211) 1)
    (at 9.008 (= (ingoal pn211) 0))
    (= (ingoal pn212) 1)
    (at 8.007 (= (ingoal pn212) 0))
    (= (ingoal pn213) 1)
    (at 7.006 (= (ingoal pn213) 0))

    (= (ingoal pn242) 1)
    (at 14.011 (= (ingoal pn242) 0))
    (= (ingoal pn244) 1)
    (at 13.010 (= (ingoal pn244) 0))

    (= (ingoal pn332) 1)
    (at 12.009 (= (ingoal pn332) 0))
    (= (ingoal pn334) 1)
    (at 11.008 (= (ingoal pn334) 0))

    (= (ingoal pn341) 1)
    (at 9.008 (= (ingoal pn341) 0))
    (= (ingoal pn342) 1)
    (at 8.007 (= (ingoal pn342) 0))
    (= (ingoal pn343) 1)
    (at 7.006 (= (ingoal pn343) 0))
    (= (ingoal pn344) 1)
    (at 6.005 (= (ingoal pn344) 0))

    (= (ingoal pn431) 1)
    (at 8.005 (= (ingoal pn431) 0))
    (= (ingoal pn432) 1)
    (at 7.004 (= (ingoal pn432) 0))
    (= (ingoal pn433) 1)
    (at 6.003 (= (ingoal pn433) 0))
    (= (ingoal pn434) 1)
    (at 5.002 (= (ingoal pn434) 0))

    
    (= (ingoal pn441) 1)
    (at 11.006 (= (ingoal pn441) 0))
    (= (ingoal pn442) 1)
    (at 10.005 (= (ingoal pn442) 0))
    (= (ingoal pn443) 1)
    (at 3.002 (= (ingoal pn443) 0))
    (= (ingoal pn444) 1)
    (at 2.001 (= (ingoal pn444) 0))

    (at 11.006 (not (deadline-open)))
)
