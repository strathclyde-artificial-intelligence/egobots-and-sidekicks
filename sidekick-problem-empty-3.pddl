...
(:init
    ...
    (welder-pick-up-valid lsid)

    (welder-pick-up-valid l11)
    (welder-pick-up-valid l12)
    (welder-pick-up-valid l13)
    (welder-pick-up-valid l14)

    (welder-pick-up-valid l21)
    (welder-pick-up-valid l22)
    (welder-pick-up-valid l23)
    (welder-pick-up-valid l24)

    (welder-pick-up-valid l31)
    (welder-pick-up-valid l32)
    (welder-pick-up-valid l33)
    (welder-pick-up-valid l34)

    (welder-pick-up-valid l41)
