...
(:init
    ...
    (at 7.007 (not (is-not-inspected pn212)))
    (is-not-inspected pn213)
    (at 7.007 (not (is-not-inspected pn213)))
    (is-not-inspected pn214)
    (at 7.007 (not (is-not-inspected pn214)))
    (is-not-inspected pn312)
    (at 9.009 (not (is-not-inspected pn312)))
